...
def get_incumbent_trace_over_time(
    ...
    Args:
        ...
        reduce_footprint: bool
            Reduce the footprint of the incumbent trace by removing duplicate entries.
    ...
    if use_neps_cost:
        ...
        # TODO: cumulative cost returned from the training objective
        cost = ...
...
if __name__ == "__main__":
    ...
    for i, algo in enumerate(args.algos):
        # TODO: make the correct computation here
        inc_performance, cost = ...
        plt.step(
            cost,
            inc_performance,
            label=algo,
